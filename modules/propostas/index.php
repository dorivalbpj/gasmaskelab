...
// A PAGAR - EXCLUINDO LANÇAMENTOS DE CARTÃO DE CRÉDITO
// Pois esses são gerenciados pelas faturas, não como pagamentos individuais
$pagar_atrasado = $pdo->query("
    SELECT SUM(valor) as total, COUNT(*) as qtd 
    FROM fin_lancamentos 
    WHERE status IN ('pendente','atrasado') 
      AND data_vencimento < CURDATE() 
      AND (forma_pagamento IS NULL OR forma_pagamento != 'cartao')
")->fetch();
...
// Soma pendentes + atrasados da semana atual (A PAGAR) - EXCLUINDO CARTÃO
